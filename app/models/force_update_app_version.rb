...
class ForceUpdateAppVersion < ApplicationRecord
  ...
  # Removed the presence validation as per the patch
  validates :reason, length: { maximum: 500, too_long: I18n.t('activerecord.errors.models.force_update_app_version.attributes.reason.too_long') }, if: :reason?
end
