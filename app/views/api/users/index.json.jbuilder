if @message.present?
  ...
  json.users @users do |user|
    ...
    json.password_reset_requests user.password_reset_requests do |password_reset_request|
      json.id password_reset_request.id
      json.created_at password_reset_request.created_at
      json.updated_at password_reset_request.updated_at
      json.request_time password_reset_request.request_time
      json.status password_reset_request.status
      json.user_id password_reset_request.user_id
    end
  end
end
